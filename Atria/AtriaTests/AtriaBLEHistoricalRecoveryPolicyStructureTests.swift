...
final class AtriaBLEHistoricalRecoveryPolicyStructureTests: XCTestCase {
    ...
    func testHistoricalRecoveryPolicyIsExtractedAndRemainsPure() throws {
        ...
        let functionNames = [
            ...
            "shouldRediscoverServicesForIdleWindowHistoryDrain",
            "shouldPauseHeartRateForIdleWindowHistoryDrain",
            "shouldStartIdleWindowHistoryGeneration",
            ...
            "shouldTimeoutIdleWindowHeartRateUnsubscribe",
            "shouldServeIdleWindowHistoryWithoutMatchedRange",
