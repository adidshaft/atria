...
HISTORICAL_ARCHIVE_KEYS = {
    ...
    "candidate_rr_values",
    "hist_versions",
    "historical_gravity_rows",
    "historical_gravity_validated_rows",
    "unix_first",
    "unix_last",
        ...
        if historical_archive:
            ...
            gates = {
                "H": {
                    ...
                    "historical_archive_gravity_rows": historical_archive.get("historical_gravity_rows", "0"),
                    "historical_archive_gravity_validated_rows": historical_archive.get("historical_gravity_validated_rows", "0"),
