...
class HandoffStaticChecks(unittest.TestCase):
    ...
    def test_handoff_21_uniform_cards_avoid_clipping_and_nested_raised_chrome(self):
        ...
        assert_contains(self, live_workout, "workoutSourceStrip(zone)")
        assert_contains(self, live_workout, "workoutCoachCueCard(zone)")
        assert_contains(self, live_workout, "workoutTargetLane(zone)")
        assert_contains(self, live_workout, "private func workoutSourceStrip(_ zone: HRZone) -> some View")
        assert_contains(self, live_workout, "private func workoutCoachCueCard(_ zone: HRZone) -> some View")
        assert_contains(self, live_workout, "private func workoutTargetLane(_ zone: HRZone) -> some View")
        assert_contains(self, live_workout, "Text(\"Target lane\")")
        assert_contains(self, live_workout, "targetLaneChip(title: \"Zone\", value: \"Z\\(zone.rawValue)\", tint: zone.color)")
        assert_contains(self, live_workout, "targetLaneChip(title: \"Strain\", value: String(format: \"%.1f\", strain), tint: Metrics.electricStrain)")
        assert_contains(self, live_workout, "targetLaneChip(title: \"Target\", value: strainTargetValueText, tint: coachCueTint)")
        assert_contains(self, live_workout, "Target lane. Heart rate zone")
        assert_contains(self, live_workout, "private func targetLaneChip(title: String, value: String, tint: Color) -> some View")
        ...
        assert_contains(self, live_workout, 'stripPill(title: "Source", value: "Strap HR", systemImage: "bolt.heart.fill", tint: zone.color)')
        assert_contains(self, live_workout, 'stripPill(title: "Review", value: "Confirm later", systemImage: "checkmark.bubble.fill", tint: .white)')
        assert_contains(self, live_workout, "Workout source is strap heart rate. End workout to confirm or adjust the session later.")
        assert_contains(self, live_workout, "zoneFocusCard(zone)")
        ...
        assert_contains(self, live_workout, "private func zoneFocusCard(_ zone: HRZone) -> some View")
        assert_contains(self, live_workout, "Label(\"Zone focus\", systemImage: \"scope\")")
    ...
    def test_developer_only_surfaces_are_hidden_by_default(self):
        ...
        for needle in [
            ...
            "Used for calories and heart-rate zones.",
