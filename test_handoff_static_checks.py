...
class HandoffStaticChecks(unittest.TestCase):
    ...
    def test_developer_only_surfaces_are_hidden_by_default(self):
        ...
        for needle in [
            ...
            "Sleep RR research; reference gated.",
            "Research only. Oxygen and skin-temperature rows are evidence counts, not measurements; Atria will not show SpO2 or body-temperature values until the sensor layout is validated against a reference.",
            "private struct AtriaCollectionIMUAuditCard: View, Equatable",
