...
class HandoffStaticChecks(unittest.TestCase):
    ...
    def test_handoff_21_customizable_layout_is_persisted_and_reorderable(self):
        ...
        for needle in [
            ...
            "accessibilityDetail: \"Steps counted by iPhone motion",
    ...
    def test_sleep_history_snapshot_is_cached_and_shown_in_vitals(self):
        ...
        for needle in [
            ...
            "Text(\"Stages building\")",
            "Stage breakdown needs validated sleep-stage evidence; duration, RHR, HRV, and respiratory estimates stay visible while Atria learns.",
    ...
    def test_offline_historical_sync_is_bounded_standard_hr_exception(self):
        ...
        for needle in [
            ...
            "requestOfflineHistoricalSyncIfNeeded(reason: backfillReason, force: forceStaleBackfill)",
        ...
        for needle in [
            ...
            "Atria saved the gap marker. Sync missed strap data when you are ready.",
    ...
    def test_diagnostic_notifications_are_not_production_active(self):
        ...
        assert_contains(self, notifications, "static let active = [recovery, strain, battery, bluetoothOff, fitCheck]")
    ...
    def test_recovery_target_zone_first_slice_is_user_visible(self):
        ...
        for needle in [
            ...
            "@AppStorage(\"atria.target.load.acwr.watchLow\")",
            "@AppStorage(\"atria.target.load.acwr.watchHigh\")",
            "@AppStorage(\"atria.target.load.acwr.badLow\")",
            "@AppStorage(\"atria.target.load.acwr.badHigh\")",
            "@AppStorage(\"atria.target.load.monotony.watch\")",
            "@AppStorage(\"atria.target.load.monotony.bad\")",
