...
- `main` is the default integration branch; a branch name alone is not release acceptance.
- `dev` carries ongoing development and can include unfinished protocol experiments.
- Open a focused pull request against the intended base and identify that base in the PR.
